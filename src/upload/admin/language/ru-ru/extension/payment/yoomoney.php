...
$_['kassa_payment_subject_default_description'] = 'Признаки предмета расчёта и способа расчёта берутся из атрибутов товара Признак предмета расчета и Признак способа расчета . Их значения можно задать отдельно в карточке товара, если это потребуется. <a href="https://yookassa.ru/developers/54fz/basics#ffd-1-05">Подробнее.</a>
